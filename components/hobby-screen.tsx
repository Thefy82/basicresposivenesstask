...
export type HobbyScreenType = {
  className?: string;
};

const HobbyScreen: NextPage<HobbyScreenType> = ({ className = "" }) => {
  return (
    <div
      className={`absolute top-[86px] left-[0px] w-[1440px] h-[678px] text-left text-xs text-base-black font-text-sm-bold ${className}`}
    >
            ...
            <div className="flex flex-col items-start justify-start gap-[24px]">
              <div className="w-[410px] relative h-4">
                ...
                <div className="absolute top-[0px] left-[279px] w-[131px] h-4">
                  ...
                  />
                  <div className="absolute top-[0px] left-[23.6px] leading-[16px] inline-block w-[107.4px]">
                    Forgot password?
                  </div>
                </div>
              </div>
