...
export type ListingFormContainer1Type = {
  className?: string;
};

const ListingFormContainer1: NextPage<ListingFormContainer1Type> = ({
  className = "",
}) => {
  return (
    <div
    ...
    >
      ...
      <div className="absolute top-[112px] left-[40px] w-[360px] h-[175px] text-white">
...
export default ListingFormContainer1;
