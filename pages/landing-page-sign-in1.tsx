...
import HobbyCommunityContainer2 from "../components/hobby-community-container2";
import FormFooter from "../components/form-footer";
import TestimonialContainer from "../components/testimonial-container";
import HobbyScreen1 from "../components/hobby-screen1";
import NavBar2 from "../components/nav-bar2";

const LandingPageSignIn1: NextPage = () => {
  return (
    <div className="w-full relative bg-white h-[3771px] overflow-hidden text-left text-5xl text-base-black font-text-sm-bold">
      ...
      <HobbyCommunityContainer2 />
      <FormFooter />
      <TestimonialContainer />
      <img
        className="absolute top-[2923px] left-[1340px] w-10 h-10"
        alt=""
        src="/group-77.svg"
      />
      <HobbyScreen1 />
